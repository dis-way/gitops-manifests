...
- **4) Naming expectations (automation)**
  - **Folder name**: `oci/<name>/`
  - **Release Please component**: `oci-<name>`
  - **Release tag format** (expected by workflows): `oci-<name>-vX.Y.Z`
    - Parsed by `.github/workflows/flux-release-artifact.yml` and `.github/workflows/flux-manage-releases.yml`.
