...
- **`--check` re-verifies the committed bytes against upstream** and runs on every pull request touching this package. It catches a hand-edit of the generated file, and an upstream asset that changed after it was vendored — release assets are mutable, unlike git tags.
